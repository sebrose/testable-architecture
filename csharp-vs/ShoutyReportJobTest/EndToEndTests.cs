...
namespace ShoutyReport
{
    ...
    public class EndToEndTests
    {
        ...
        public void single_sales_person()
        {
            ...
            // run report
            Run("ShoutyReportJob.exe", "..\\..\\TestData\\test_case_1_input.csv");

            // check XML report has been generated
            Assert.IsTrue(File.Exists("report.xml"));
            assertXmlFilesEqual(
                "..\\..\\TestData\\test_case_1_expected.xml",
                "report.xml"
            );
        }
        ...
        {
            // run report
            Run("ShoutyReportJob.exe", "..\\..\\TestData\\test_case_2_input.csv");

            // check XML report has been generated
            Assert.IsTrue(File.Exists("report.xml"));
            assertXmlFilesEqual(
                "..\\..\\TestData\\test_case_2_expected.xml",
                "report.xml"
            );
        }
