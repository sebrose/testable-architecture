...
public class EndToEndTests {
    ...
    public void multiple_sales_people() throws Exception {
        // run report
        run("shouty.reporting.ShoutyReportJob", "test_data/test_case_2_input.csv");

        // check XML report has been generated
        Assert.assertTrue(new File("report.xml").isFile());
        assertXmlFilesEqual(
            "test_data/test_case_2_expected.xml",
            "report.xml"
        );
    }
